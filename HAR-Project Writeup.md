...
##    2) PC13< 0.6849755 8865 6074 A (0.31 0.23 0.21 0.15 0.096)  
##      4) PC20< 0.6640599 6302 3598 A (0.43 0.26 0.15 0.093 0.069) *
##      5) PC20>=0.6640599 2563 1608 C (0.034 0.14 0.37 0.29 0.16)  
##       10) PC2< 1.440709 1847  896 C (0.047 0.2 0.51 0.22 0.021) *
##       11) PC2>=1.440709 716  339 E (0 0 0.0056 0.47 0.53) *
##    3) PC13>=0.6849755 2911 1597 E (0.19 0.092 0.058 0.21 0.45) *
```
...
##      
## pred1    A    B    C    D    E
##     A 1832 1094  575  388  309
##     B    0    0    0    0    0
##     C   48  240  679  281   36
##     D    0    0    0    0    0
##     E  352  184  114  617 1097
```
...
## 
## Call:
##  randomForest(formula = classe ~ ., data = trainN1, ntree = 500) 
...
## 
## Call:
##  randomForest(formula = classe ~ ., data = trainN, ntree = 500) 
##                Type of random forest: classification
##                      Number of trees: 500
## No. of variables tried at each split: 7
## 
